    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Choose a sign-in method</p>
        </div>
            ...
            {state === "idle" && (
              <div className="space-y-2">
                ...
                <button
                  ...
                  disabled={!email || !!loading}
                  className="w-full rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
                >
        ...
        {state === "code-verify" && (
          <form onSubmit={handleVerifyCode} className="space-y-3">
            ...
            <input
              ...
              placeholder="12345"
              className="block w-full rounded-md border border-gray-300 px-3 py-2 text-center text-2xl tracking-widest focus:border-gray-900 focus:outline-none"
              autoFocus
            />
            <button
              type="submit"
          ...
          <>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={!!loading}
                className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
              >
